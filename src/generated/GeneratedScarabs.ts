...
export const scarabs: { [key: string]: Scarab } = {
 ...
 "Ambush Scarab": {
   ...
   description: "Area contains 5 additional Strongboxes",
 ...
 "Divination Scarab of Plenty": {
   ...
   description: "Up to 3 Packs of Magic Monsters in Area drop additional Divination Cards",
 ...
 "Incursion Scarab of Invasion": {
   ...
   description: "Area contains 12-16 additional packs of Incursion Monsters",
 ...
 "Ritual Scarab of Wisps": {
   ...
   description: "Ritual Altars in Area spawn a Wildwood Wisp Wildwood Wisps grant 70% increased Tribute Gained to nearby Players",
