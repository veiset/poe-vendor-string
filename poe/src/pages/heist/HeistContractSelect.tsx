...
import agility from '@shared/img/heist/Agility.png';
import bruteForce from '@shared/img/heist/Brute Force.png';
import counterThaumaturgy from '@shared/img/heist/Counter-Thaumaturgy.png';
import deception from '@shared/img/heist/Deception.png';
import demolition from '@shared/img/heist/Demolition.png';
import engineering from '@shared/img/heist/Engineering.png';
import lockpicking from '@shared/img/heist/Lockpicking.png';
import perception from '@shared/img/heist/Perception.png';
import trapDisarmament from '@shared/img/heist/Trap Disarmament.png';
