...
import FlaskModList from "@poe/components/FlaskModList";
import {flaskPrefix, flaskSuffix} from "@poe/generated/GeneratedFlaskMods";
import {loadSettings, saveSettings} from "@poe/utils/LocalStorage";
import {Checkbox} from "@shared/components/Checkbox/Checkbox";
import {generateFlaskOutput, minItemLevel} from "@poe/utils/FlaskOuput";
import {defaultSettings, FlaskSettings} from "@poe/utils/SavedSettings";
...
const Flasks = () => {
  ...
  return (
    <>
      ...
      <RegexResultBox result={result} warning={minIlevel} reset={() => {
