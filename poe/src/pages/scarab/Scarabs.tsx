...
import {defaultSettings, ScarabSettings} from "@poe/utils/SavedSettings";
...
const Scarabs = () => {
  ...
  return (
    <>
      ...
      />
      <div className="break"/>
      <p className="scarab-price-info">Using price data from the {league} League. Last updated: {lastUpdated}</p>
